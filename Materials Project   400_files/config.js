define(["require"], function() {
  return requirejs.config({
    ...
    paths: {
      ...
      "three-full": "../../components/crystaltoolkit/ThreeFull.amd.min",
      "simple3dscene": "../../components/crystaltoolkit/Simple3DScene.amd.min",
      "iframeResizer": "../modules/iframeResizer.min"
    },
    waitseconds: 20000,
    shim: {
      jquery: {
